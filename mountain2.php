...
<title>LERUN BONUS GENT 26" BLUE BLUE</title>
...
<br>
<br><br>
<h1 align="center"><strong>Lerun Bonus Gent 26" Blue Blue</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveMountain2.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/lerunlady.jpg" alt="Lerun2" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
    ...
    <tr> 
      <td>
	  <p align="left">Type - MTB 26" Rigid Frame Gent</p>	  
      </td>
    </tr>
	<tr>
      <td>
