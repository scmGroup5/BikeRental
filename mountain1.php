...
<title>Lerun Bonus Gent 24" Black Yellow</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*100*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Lerun Bonus Gent 24" Black Yellow</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveMountain1.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/lerunmountain.jpg" alt="Lerun1" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM100.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - MTB 24" Rigid Frame Gent</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Speed - 18 Speed</p>	  
      </td>
    </tr>
    <tr>
      <td>
