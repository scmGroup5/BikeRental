...
<br>
<br><br>
<h1 align="center"><strong>Polygon Helios C6 </strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveRoad4.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/road5.png" alt="road4" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
	...
	<tr>
      <td>
	  <p align="left">Tyre - SCHWALBE DURANO BK</p>	  
      </td>
    </tr>
    <tr>
      <td>
