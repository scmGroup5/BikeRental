...
<br/>
<td>
<form action="searchbooking.php" method="POST" text align="center">
...
<br>
  ...
  <table border="1" table align="center" id="myTable">
	...
	<th width="112">Action</th>
         ...
         <?php
		include('config.php');
		$result3 = mysql_query("SELECT * FROM booking");
...
<br><br>
<form action="refresh5.php" method="POST" text align="center">
