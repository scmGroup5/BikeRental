...
<title>Polygon Helios C3 White</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*90*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Polygon Helios C3 White</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveRoad1.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/road2.jpg" alt="road1" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM90.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - carbon ACX frame</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Tyre - Schwalbe Lugano tyres</p>	  
      </td>
    </tr>
    <tr>
      <td>
