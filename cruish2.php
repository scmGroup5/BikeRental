...
<title>Garion Korean Style City Bike</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*105*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Garion Korean Style City Bike</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveCruish2.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/cru3.png" alt="cruish2" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM105.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - 24" Hi-Ten Steel City Bike</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Brake - Front Caliper & Rear Hub Band</p>	  
      </td>
    </tr>
    <tr>
      <td>
