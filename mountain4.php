...
<title>POLYGON SISKIU GENT 29" FULL BLACK</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*135*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Polygon Siskiu Gent 29" Full Black</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveMountain4.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/polygonblack.png" alt="Polygon" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM135.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - solid and reliable ALX frame</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Speed - 11 Speed</p>	  
      </td>
    </tr>
    <tr>
      <td>
