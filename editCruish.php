...
<br>
  ...
  <form action="updateCruish.php" method="post" enctype="multipart/form-data" name="form1" class="smart-green" onsubmit="return myFunction()">



 <h1>Edit Cruish Bikes Quantity</h1>

<label>New Quantity for Asogo:</label>
<input type="number" name="quantity" id="quantity" required>
<br>
<br>

<label>New Quantity for Garion:</label>
<input type="number" name="quantity2" id="quantity2" required>
<br>
<br>

<label>New Quantity for Electric:</label>
<input type="number" name="quantity3" id="quantity3" required>
<br>
<br>

<label>New Quantity for Apollo:</label>
