...
<title>Polygon Stratos S2 Black</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*110*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Polygon Stratos S2 Black</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveRoad2.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/road3.jpg" alt="road2" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM110.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - frame with a carbon fiber fork</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Tyre - Araya rims with Kenda Kontender</p>	  
      </td>
    </tr>
    <tr>
      <td>
