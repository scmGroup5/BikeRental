...
<br/>
<td>
<form action="searchfeedback.php" method="POST" text align="center">
...
<br>
  ...
  <table border="1" table align="center" id="myTable">
     <tr bgcolor="#cccccc" style="margin-bottom:100px";text align="center"; >
	  ...
	  <th width="232" onclick="sortTable(1)">Name</th>
	  <th width="200" onclick="sortTable(2)">Contact</th>
	  <th width="250" onclick="sortTable(3)">Email</th>
	  <th width="300" onclick="sortTable(4)">Feedback</th>
	  <th width="50">Action</th>
     </tr>
			
         <?php
		include('config.php');
		$result3 = mysql_query("SELECT * FROM feedback");
		while($row3 = mysql_fetch_array($result3))
		{
			echo '<tr>';
			echo '<td text align="center">'.$row3['id'].'</td>';
			echo '<td text align="center">'.$row3['name'].'</td>';
			echo '<td text align="center">'.$row3['contact'].'</td>';
			echo '<td text align="center">'.$row3['email'].'</td>';
			echo '<td>'.$row3['feedback'].'</td>';
			echo '<td text align="center">';
			echo'<a href=deletefeedback.php?id=' . $row3["id"] . '>' . 'Delete' . '</a>';
			echo '</td>';
			echo '</tr>';
...
<br><br>
<form action="refresh2.php" method="POST" text align="center">
