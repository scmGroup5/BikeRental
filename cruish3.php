...
<title>Electric Bicycle EBike - EB2</title>
...
function calculation()
	{
		...
		var dropdt = new Date(document.getElementById("ReturnDate").value);
                ...
                return parseInt((((dropdt - pickdt)/ (24 * 3600 * 1000))+1)*200*quantity);
	}
...
<br>
<br><br>
<h1 align="center"><strong>Electric Bicycle EBike - EB2</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveCruish3.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/cru4.jpg" alt="cruish3" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
         
	  <h3 style="color: red;">RM200.00/day</h3>
      </td>
    </tr>
    <tr> 
      <td>
	  <p align="left">Type - Battery Meter</p>	  
      </td>
    </tr>
	<tr>
      <td>
	  <p align="left">Brake - Drum Bake</p>	  
      </td>
    </tr>
    <tr>
      <td>
