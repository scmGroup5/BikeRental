...
<title>MARIN BOBCAT TRAIL 27.5" SKY BLUE</title>
...
<br>
<br><br>
<h1 align="center"><strong>Marin Bobcat Trail 27.5" Sky Blue</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveMountain3.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/marin.jpg" alt="Marin" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
