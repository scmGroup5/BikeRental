...
<br>
  ...
  <form action="updateMountain.php" method="post" enctype="multipart/form-data" name="form1" class="smart-green" onsubmit="return myFunction()">



 <h1>Edit Mountain Bikes Quantity</h1>

<label>New Quantity for Lerun1:</label>
<input type="number" name="quantity" id="quantity" required>
<br>
<br>

<label>New Quantity for Lerun2:</label>
<input type="number" name="quantity2" id="quantity2" required>
<br>
<br>

<label>New Quantity for Marin:</label>
<input type="number" name="quantity3" id="quantity3" required>
<br>
<br>

<label>New Quantity for Polygon:</label>
