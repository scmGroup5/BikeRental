...
<br>
  <table border="1" table align="center">
	...
	<th width="248">Frame Size</th>
	<th width="248">Saddle Type</th>
	<th width="248">Tyre Size</th>
	<th width="248">Booking Date</th>
	<th width="248">Return Date</th>
	<th width="248">Days</th>
	<th width="248">Price (RM)</th>
	<th width="248">Quantity</th>
...
<?php
    ...
    $query = $_POST['query'];  
        ...
        $raw_results = mysql_query("SELECT * FROM booking WHERE (`Username` LIKE '%".$query."%')");
	    ...
	    {	
			...
			echo '<td text align="center">'.$row3['Type'].'</td>';
			echo '<td text align="center">'.$row3['FrameSize'].'</td>';
			echo '<td text align="center">'.$row3['SaddleType'].'</td>';
			echo '<td text align="center">'.$row3['TyreSize'].'</td>';
			echo '<td text align="center">'.$row3['BookingDate'].'</td>';
			echo '<td text align="center">'.$row3['ReturnDate'].'</td>';
			echo '<td text align="center">'.$row3['Days'].'</td>';
			echo '<td text align="center">'.$row3['Price'].'</td>';
			echo '<td text align="center">'.$row3['Quantity'].'</td>';
			echo '<td text align="center">';
			echo'<a rel="facebox" href=deletebooking2.php?id=' . $row3["ID"] . '>' . 'Delete' . '</a>';
			echo '</td>';
			echo '</tr>';
        }
		?>
     ...
     <form action="viewbookings.php" method="POST" text align="center">
