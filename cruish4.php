...
<title>Apollo Nouveau 7 WS</title>
...
<br>
<br><br>
<h1 align="center"><strong>Apollo Nouveau 7 WS</strong></h1>
<hr></hr>
<div id="bodyContainer">
<br>
<form action="SaveCruish4.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return myFunction()">
  <div class="img">
  <table style="width:100%">
		
    <tr>
      <td rowspan="10" style="width:40%">
	  <p><img src="biketype/cru5.jpg" alt="cruish4" height="320" width="320" class="frame"/></a></p>      
      </td>
      <td align="left">
    ...
    <tr> 
      <td>
	  <p align="left">Type - rack and fender mounts</p>	  
      </td>
    </tr>
	<tr>
      <td>
