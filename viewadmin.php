...
<br/>
<td>
<p> <h4> <a href="addadmin.php">Add New Admin</a> <br /></p></h4>
  <table border="1" table align="center" id="myTable">
     <tr bgcolor="#cccccc" style="margin-bottom:100px"; text align="center">
          <th width="50" onclick="sortTable(0)">No</th>
	  <th width="232" onclick="sortTable(0)">Username</th>
	  <th width="248" onclick="sortTable(0)">Password</th>
	  <th width="112" onclick="sortTable(0)">Action</th>
     </tr>
		...
		while($row3 = mysql_fetch_array($result3))
		{
			...
			echo'<a rel="facebox" href=editadmin.php?id=' . $row3["id"] . '>' . 'Edit' . '</a>';
			echo ' | ';
			echo'<a href=deleteadmin.php?id=' . $row3["id"] . '>' . 'Delete' . '</a>';
			echo '</td>';
			echo '</tr>';
...
<br><br>
<form action="refresh3.php" method="POST" text align="center">
